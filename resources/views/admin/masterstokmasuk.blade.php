...
@section('title', 'Master Stok Masuk')
@section('content')
    ...
    <div class="main-wrapper">
        <div class="row">
            <div class="col">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Master Stok Masuk</h5>
                        <div class="tambah-stokmasuk mb-3">
                            <a href="{{ route('stokmasuk.create')}}" class="btn btn-success">Tambah Stok Masuk</a>
                        </div>
                        <div class="mb-3">
                                    ...
                                    <td>
                                        <div class="d-flex gap-2">
                                            <div class="update d-flex align-items-center">
                                                <a href="{{ route('stokmasuk.edit', $item->id) }}">
